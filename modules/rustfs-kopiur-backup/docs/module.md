...
| <a name="input_onepassword_vault_id"></a> [onepassword\_vault\_id](#input\_onepassword\_vault\_id) | UUID of the 1Password vault the "<name>#<env>" item (see var.name) is created in. | `string` | n/a | yes |
